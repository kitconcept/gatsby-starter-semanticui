...
const GridLayout = () => (
  <Layout>
    ...
    <Container text>
      ...
      <p>
        A container is a fixed width element that wraps your site's content. It
        remains a constant size and uses <b>margin</b> to center. Containers are
        the simplest way to center page content inside a grid.
      </p>
    </Container>
    <Divider hidden />
    <Container>
    ...
    <Container text>
      ...
      <p>
        Sometimes you just need to put a single column of centered text on a
        page. A <code>text container</code> is a special type of container
        optimized for a single flowing column of text, like these instructions
        on this page.
      </p>
      <p>
        Text containers <b>do not need to use grids</b> and help simplify basic
        page layouts.
      </p>
      ...
      <p>
        ...
        <code>columns</code> as direct child of
        <code>ui grid</code> content will automatically flow to the next row
      ...
      <p>
        Adding row wrappers allow you to manually specify you want a new row to
        begin.
      </p>
      ...
      <p>
        Specifying a grid column count will divide columns into rows of
        predetermined column count. Additional columns will automatically flow
        to the next row.
      </p>
      <Grid columns={3}>
      ...
      <p>
        Some special variations that format grids like tables require you to
        specify rows. For example a<code>divided grid</code> or a{' '}
        <code>celled grid</code> requires row wrappers.
      </p>
      ...
      <p>
        ...
        <code>ui centered grid</code>,<code>centered row</code>, or{' '}
        <code>centered column</code> to center the column contents inside the
        grid.
      </p>
      ...
      <p>
        ...
        <code>left floated</code> item should come first, and a
      ...
      <p>
        You can specify text alignment using alignment variations on a grid,
        row, or column level.
      </p>
      ...
      <p>
        Specifying an <code>equal width grid</code> will automatically determine
        column sizes to fit evenly inside one row.
      </p>
      ...
      <p>
        You can specify columns to appear at different widths on different
        screens.
      </p>
